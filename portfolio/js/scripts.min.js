...
$(function(){var n=document.getElementById("video1");$("#video1, #video_play").click(function(){n.volume=.2,n.paused?n.play():n.pause()}),n.onplay=function(){$("#video_play").toggleClass("video_play_start")},n.onpause=function(){$("#video_play").toggleClass("video_play_start")};new Swiper(".swiper-container",{pagination:".swiper-pagination",paginationClickable:!0});baguetteBox.run(".gallery");var e=$("#my-menu").mmenu({offCanvas:{position:"right"},pageScroll:!0}),i=$("#my-icon"),o=e.data("mmenu");i.on("click",function(){o.open()}),o.bind("open:start",function(){setTimeout(function(){i.addClass("is-active")},100)}),o.bind("close:start",function(){setTimeout(function(){i.removeClass("is-active")},100)})});
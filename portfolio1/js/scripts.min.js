...
$(function(){$("a[href*='#']").mPageScroll2id({offset:50}),$(window).scroll(function(){$(document).scrollTop()>150?$("#desktop").addClass("fixed"):$("#desktop").removeClass("fixed")}),$("#nav-icon1,#nav-icon2,#nav-icon3,#nav-icon4").click(function(){$(this).toggleClass("open"),$("#navbar").toggleClass("visible"),$("body").toggleClass("fixedPosition")}),$(".mainLinks").click(function(){$("#navbar").toggleClass("visible"),$("#nav-icon1,#nav-icon2,#nav-icon3,#nav-icon4").toggleClass("open")});$(".second-life").waypoint({handler:function(e){"down"===e&&($(".4itemdesktop").removeClass("active-mobile-nav-item"),$(".3itemdesktop").removeClass("active-mobile-nav-item"),$(".2itemdesktop").removeClass("active-mobile-nav-item"),$(".1itemdesktop").addClass("active-mobile-nav-item"))}}),$(".third").waypoint({handler:function(e){"down"===e&&($(".4itemdesktop").removeClass("active-mobile-nav-item"),$(".3itemdesktop").removeClass("active-mobile-nav-item"),$(".2itemdesktop").addClass("active-mobile-nav-item"),$(".1itemdesktop").removeClass("active-mobile-nav-item"))},offset:50}),$(".four").waypoint({handler:function(e){"down"===e&&($(".4itemdesktop").removeClass("active-mobile-nav-item"),$(".3itemdesktop").addClass("active-mobile-nav-item"),$(".2itemdesktop").removeClass("active-mobile-nav-item"),$(".1itemdesktop").removeClass("active-mobile-nav-item"))},offset:50}),$(".five").waypoint({handler:function(e){"down"===e&&($(".4itemdesktop").addClass("active-mobile-nav-item"),$(".3itemdesktop").removeClass("active-mobile-nav-item"),$(".2itemdesktop").removeClass("active-mobile-nav-item"),$(".1itemdesktop").removeClass("active-mobile-nav-item"))},offset:60}),$(".second-life").waypoint({handler:function(e){"up"===e&&($(".4itemdesktop").removeClass("active-mobile-nav-item"),$(".3itemdesktop").removeClass("active-mobile-nav-item"),$(".2itemdesktop").removeClass("active-mobile-nav-item"),$(".1itemdesktop").addClass("active-mobile-nav-item"))}}),$(".third").waypoint({handler:function(e){"up"===e&&($(".4itemdesktop").removeClass("active-mobile-nav-item"),$(".3itemdesktop").removeClass("active-mobile-nav-item"),$(".2itemdesktop").addClass("active-mobile-nav-item"),$(".1itemdesktop").removeClass("active-mobile-nav-item"))}}),$(".four").waypoint({handler:function(e){"up"===e&&($(".4itemdesktop").removeClass("active-mobile-nav-item"),$(".3itemdesktop").addClass("active-mobile-nav-item"),$(".2itemdesktop").removeClass("active-mobile-nav-item"),$(".1itemdesktop").removeClass("active-mobile-nav-item"))}}),$(".five").waypoint({handler:function(e){"up"===e&&($(".4itemdesktop").addClass("active-mobile-nav-item"),$(".3itemdesktop").removeClass("active-mobile-nav-item"),$(".2itemdesktop").removeClass("active-mobile-nav-item"),$(".1itemdesktop").removeClass("active-mobile-nav-item"))}});baguetteBox.run(".gallery-middle-box",{buttons:!0})}),$(function(){});